...
0. Verifica que tu repositorio cumpla con los [requisitos mínimos](#requisitos-de-ingreso-por-proyecto) (descritos abajoW)
1. Copia la carpeta [PLANTILLA](https://github.com/openutt/openutt.github.io/tree/main/content/proyectos/PLANTILLA) a `content/proyectos/<slug>/index.md` (en GitHub: fork + Add file, o edición web) y completa los campos: *nombre*, *autores*, *cuatrimestre*, *tecnologías*, *estado*, *repo*, *demo*, etc, (solo las que apliquen), una descripción breve e información adicional que quieras agregar.
![Agregando nuevo proyecto](nuevo-proyecto-openutt.png "Agregando un nuevo proyecto a OpenUTT desde VSCode")

2. Abre un Pull Request a [openutt/openutt.github.io](https://github.com/openutt/openutt.github.io) con título `proyectos: <nombre>`.
