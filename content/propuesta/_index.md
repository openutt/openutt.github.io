...
1. **Retomarlo** para su proyecto cuatrimestral.
2. **Usarlo como ejemplo** en clase (por un profesor).
...
- **Encuestas realizadas**, con análisis de las mismas respuestas.
- **Índice de repositorios** y una página web sencilla de la misma.
- **Primera comunidad** de estudiantes conectados en Discord queriendo ser parte de la iniciativa.

{{< alert "edit" >}}
Como se mencionó antes, todo esto tiene un **presupuesto de $0**, pues GitHub da límites muy generosos a organizaciones y proyectos públicos/open source.
{{< /alert >}}
